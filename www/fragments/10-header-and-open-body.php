<head>
	...
	<link rel="stylesheet" type="text/css" href="extras/styles.css?litbasketsRevision=29" />
	...
	<script src="extras/sidebar-tab-switcher.js?litbasketsRevision=29"></script>
	<script src="extras/api.js?litbasketsRevision=29"></script>
	<script src="extras/index.model.js?litbasketsRevision=29"></script>
	<script src="extras/index.controller.js?litbasketsRevision=29"></script>
	<script src="extras/index.controller.search.js?litbasketsRevision=29"></script>
	<script src="extras/index.controller.sources.js?litbasketsRevision=29"></script>
