<head>
	...
	<link rel="stylesheet" type="text/css" href="extras/styles.css?litbasketsRevision=30" />
	...
	<script src="extras/sidebar-tab-switcher.js?litbasketsRevision=30"></script>
	<script src="extras/api.js?litbasketsRevision=30"></script>
	<script src="extras/index.model.js?litbasketsRevision=30"></script>
	<script src="extras/index.controller.js?litbasketsRevision=30"></script>
	<script src="extras/index.controller.search.js?litbasketsRevision=30"></script>
	<script src="extras/index.controller.sources.js?litbasketsRevision=30"></script>
