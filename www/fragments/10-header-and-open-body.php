<head>
	...
	<link rel="stylesheet" type="text/css" href="extras/styles.css?litbasketsRevision=39" />
	...
	<script src="extras/sidebar-tab-switcher.js?litbasketsRevision=39"></script>
	<script src="extras/api.js?litbasketsRevision=39"></script>
	<script src="extras/index.model.js?litbasketsRevision=39"></script>
	<script src="extras/index.controller.search.js?litbasketsRevision=39"></script>
	<script src="extras/index.controller.sources.topbar.js?litbasketsRevision=39"></script>
	<script src="extras/index.controller.sources.js?litbasketsRevision=39"></script>
	<script src="extras/index.controller.filters.js?litbasketsRevision=39"></script>
	<script src="extras/index.controller.js?litbasketsRevision=39"></script>
