<div id="litbaskets-about" style="display: none; width: 90%; max-width: 90rem; margin: 0 auto; padding: 1rem;">
	<h1>Help</h1>
	<h2>
		How can I search with Litbaskets?
	</h2>
	<p class="litfam_faq_para">
		The easiest way to start a search is to type your search term(s) into the search bar on the main Search page. Then click "Search" and this will redirect you to the search results page on the Scopus database.
	</p>
